...
class SpackExercise(CMakePackage):
    """An example project for learning how to package software using Spack."""
    ...
    license("MIT", checked_by="Vaish-W")
    ...
    version('main', branch='main', git='https://github.com/Simulation-Software-Engineering/spack-exercise.git')
