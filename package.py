...
class SpackExercise(CMakePackage):
    """SpackExercise is a sample project demonstrating how to create and 
       manage Spack packages with dependencies for various versions."""
    ...
    # License information
    license("UNKNOWN", checked_by="ymamo")
    ...
    depends_on("boost@1.65.1:", when="@0.2.0:")  # Boost for 0.2.0 and later
    depends_on("yaml-cpp@0.7.0:", when="@0.3.0:")  # yaml-cpp only for 0.3.0
